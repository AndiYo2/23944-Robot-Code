...
public class RedBackAuton extends OpMode {
    ...
    private final Pose endPose = new Pose(87, 45, Math.toRadians(90));

    private final Pose shootPose = new Pose(87, 11, Math.toRadians(90));
    private final Pose firstPickupPose = new Pose(123.5,33, Math.toRadians(0));
    ...
    private final Pose shootToFirstControlPoint = new Pose(81.3,30.5);
