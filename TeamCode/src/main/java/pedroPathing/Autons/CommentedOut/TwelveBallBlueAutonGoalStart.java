...
import OldSystems.IMPLEMENTED.IntakeMotors;

@Autonomous(name = "TwelveBallBlueAutonGoalStart")

public class TwelveBallBlueAutonGoalStart extends OpMode {
    ...
    private final Pose thirdPickupPose = new Pose(24, 36.5, Math.toRadians(180));
    ...
    private final Pose shootToThirdControlPoint = new Pose(76, 23);
