...
@Autonomous(name = "TwelveBallBackRedAuton")
public class TwelveBallRedAutonBackStart extends OpMode {
    ...
    private final Pose thirdPickupPose = new Pose(120, 33.5, Math.toRadians(0));
    ...
    private final Pose shootToThirdControlPoint = new Pose(64, 23);
