...
public class DefenseTestTeleOp extends CommandOpMode {
    ...
    /**
     * Like DynamicReturnPathCommand but builds the path with aggressive braking
     * constants so short returns don't spend the whole path decelerating.
     */
    private static class AggressiveReturnCommand extends CommandBase {
        private final Follower follower;
        private final Pose target;
        private final double maxPower;

        AggressiveReturnCommand(Follower follower, Pose target, double maxPower) {
