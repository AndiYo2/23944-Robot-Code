...
public class NewRed18Ball extends AutonTemplate {
    ...
    private PathChain startToShoot, shootToFirst, firstToShoot, shootToGatePrep1, gateToShoot1, shootToGatePrep2, gateToShoot2, shootToFourth, fourthToShoot, shootToFifth, fifthToShootAndStop, testingStop;
    ...
    private final Pose gatePose = new Pose(132.00, 60, Math.toRadians(15));
    private final Pose gateShootPose = new Pose(86.000, 82.000, Math.toRadians(15));
    ...
    protected void buildPaths() {
        ...
        shootToGatePrep1 = follower.pathBuilder()
                .addPath(new BezierCurve(gateShootPose, gatePrepControlPoint, gatePose))
