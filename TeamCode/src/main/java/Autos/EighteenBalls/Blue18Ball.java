...
public class Blue18Ball extends AutonTemplate {
    ...
    private final Pose upperShootPose = new Pose(52.500, 85.000, Math.toRadians(180));
    ...
    private final Pose cornerCycleMidPose = new Pose(35.000, 19.000, Math.toRadians(0));
    private final Pose cornerCycleControl = new Pose(24.000, 11.000);

    // Second spike
    private final Pose secondPrepPose = new Pose(38.017, 54.123, Math.toRadians(135));
    private final Pose secondPose = new Pose(19.000, 53.500, Math.toRadians(110));

    // Gate
    private final Pose gatePose = new Pose(17.500, 63.000, Math.toRadians(180));

    // First spike & gate
    private final Pose firstSpikePose = new Pose(16.000, 85.000, Math.toRadians(180));

    // End pose
    private final Pose endPose = new Pose(49.000, 17.500, Math.toRadians(135));

    // Control points
    private final Pose secondToGateControl = new Pose(22.000, 58.000);
