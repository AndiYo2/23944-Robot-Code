...
public class RedBackCycler extends AutonTemplate {
    ...
    // Fourth pickup
    private final Pose fourthPickupPose = new Pose(130.000, 23.000, Math.toRadians(0));
    ...
    public void init() {
        ...
        autonomousCommand = new CommandSequenceBuilder(follower, intake, spindexer, limelight, shooter, turret)
                ...
                .delay(.5)
                .parallel(p -> p.moveTo(firstToShoot, maxSpeed, false).catalog())
                .shoot()
                .intakeStart()
                ...
                .delay(.3)
                .parallel(p -> p.moveTo(fourthToShoot, maxSpeed, false).catalog())
                .shoot()
                .intakeStart()
                .moveTo(shootToFifth, maxSpeed, false)
                .delay(.3)
                .parallel(p -> p.moveTo(fifthToShoot, maxSpeed, false).catalog())
                .shoot()
